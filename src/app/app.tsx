...
const App: React.FC<AppProps> = ({ toggleTheme }) => {
    return ( <>
            ...
            <header className="flex flex-col justify-between mx-auto max-w-5xl px-4 landscape xl:max-w-screen-2xl dark:bg-gray-900 dark:text-white">
                <Navbar page={""} toggleTheme={toggleTheme} />
                <div className="flex-grow py-16">
                    <div className="flex flex-col justify-center text-center items-center">
                        <span className="text-xl font-bold text-primary dark:text-primary-dark">Hello! 👋 I'm </span>
                        <h1 className="text-8xl font-black"><span className="text-primary dark:text-primary-dark">Damien</span> Chapart</h1>
                        <h2 className="text-2xl font-black">Software engineer.</h2>
                        <p className="text-lg py-4 xl:px-16 text-secondary dark:text-gray-400">
                            I'm a student at <a href={"https://www.univ-larochelle.fr/"}>université de la rochelle </a> and software
                            engineer.
            ...
            <main className="mx-auto max-w-5xl px-4 xl:max-w-7xl xl:px-0 flex flex-col space-y-28 dark:bg-gray-900 dark:text-white">
