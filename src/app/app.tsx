    ...
    const div = <>
        ...
        <main className="mx-auto max-w-5xl px-4 xl:max-w-7xl xl:px-0 flex flex-col space-y-28">
                    ...
                    <div className={"w-full flex flex-col  justify-center"}>
                        <div
                            ...
                            <svg width="132" height="126" viewBox="0 0 132 126" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_1242_676)">
                                    <path
                                ...
                                <defs>
                                    ...
                                    <linearGradient id="paint2_linear_1242_676" x1="43.5645" y1="62.6198"
                                        ...
                                        <stop offset="0.04" stop-color="#FDC800"/>
                                        <stop offset="0.48" stop-color="#F18F34"/>
            ...
            <footer className="mx-auto max-w-5xl px-4 xl:max-w-7xl xl:px-0 flex flex-col  mt-32">
                <div className={"flex flex-col font space-y-2 w-1/3"}>
                    ...
                    <div className={"flex space-x-2 "}>
                        ...
                        <Button outline={true}
                                className={"w-full sm:w-auto flex-none bg-transparent hover:bg-secondary text-secondary hover:text-white border-gray-200 border-2 text-lg font-semibold py-2 px-2 rounded-xl focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-primary focus:outline-none transition-colors duration-200"}>
                            <div className={"uppercase tracking-wide font-bold text-xs flex flex-grow space-x-2"}>
                                <Logos.Twitter
                                    className="w-4 h-4 "/>
                            </div>
